...
const quickActions = [
  ...
  { label: "Editor plantilla", href: "/admin/plantilla", icon: ChevronRight },
  { label: "Vista del sitio", href: "/admin/preview", icon: ChevronRight },
];
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-r from-[#0B1D3A] via-[#162B4D] to-[#0B1D3A] rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl lg:text-3xl font-bold mb-2">
                Bienvenido al panel de Katemi 👋
              </h2>
              <p className="text-white/70 text-sm lg:text-base max-w-xl">
                Gestiona tus servicios, proyectos, clientes y contactos desde un
                solo lugar.
              </p>
            </div>
          </div>
        ...
        {/* Stats Grid */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8 transition-all duration-700 delay-100 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          {statsCards.map((card, index) => {
            ...
            return (
              <Link
                key={card.key}
                href={card.href}
                className="group relative block bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`w-12 h-12 rounded-xl ${card.iconBg} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
        ...
        <div
          className={`grid grid-cols-1 lg:grid-cols-3 gap-6 transition-all duration-700 delay-200 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          {/* Quick Actions */}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Icon
                        size={18}
                        className="text-gray-400 group-hover:text-[#00A896] transition-colors"
                      />
